...
def apply_premium_style():
    ...
    st.markdown("""
        ...
        .stButton > button[kind="primary"]:hover {
         ...
         /* Eliminar el contorno predeterminado de los botones al hacer click/focus */
...
@@ -117,8 +108,9 @@ def apply_premium_style():
            color: white !important;
            background: transparent !important;
        }
        /* Eliminar icono adicional que puede renderizarse como un cuadro vacío en algunos navegadores */
